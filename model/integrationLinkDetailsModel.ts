...
export class IntegrationLinkDetailsModel {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "allIntegrationLinkCount",
            "baseName": "allIntegrationLinkCount",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return IntegrationLinkDetailsModel.attributeTypeMap;
    }
}
