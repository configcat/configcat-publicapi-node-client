...
------------ | ------------- | ------------- | -------------
**name** | **string** | Name of the Permission Group. | [optional] [default to undefined]
...
```typescript
import { UpdatePermissionGroupRequest } from './api';

const instance: UpdatePermissionGroupRequest = {
    name,
    canManageMembers,
