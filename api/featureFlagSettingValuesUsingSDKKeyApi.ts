...
export enum FeatureFlagSettingValuesUsingSDKKeyApiApiKeys {
}

export class FeatureFlagSettingValuesUsingSDKKeyApi {
    ...
    public setApiKey(key: FeatureFlagSettingValuesUsingSDKKeyApiApiKeys, value: string) {
        (this.authentications as any)[FeatureFlagSettingValuesUsingSDKKeyApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getSettingValueBySdkkey (settingKeyOrId: string, xCONFIGCATSDKKEY?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SettingValueModel;  }> {
        const localVarPath = this.basePath + '/v1/settings/{settingKeyOrId}/value'
        ...
        localVarHeaderParams['X-CONFIGCAT-SDKKEY'] = ObjectSerializer.serialize(xCONFIGCATSDKKEY, "string");
     ...
     * @param xCONFIGCATSDKKEY The ConfigCat SDK Key. (https://app.configcat.com/sdkkey)
     */
    public async replaceSettingValueBySdkkey (settingKeyOrId: string, updateSettingValueModel: UpdateSettingValueModel, reason?: string, xCONFIGCATSDKKEY?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SettingValueModel;  }> {
        const localVarPath = this.basePath + '/v1/settings/{settingKeyOrId}/value'
            .replace('{' + 'settingKeyOrId' + '}', encodeURIComponent(String(settingKeyOrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param xCONFIGCATSDKKEY The ConfigCat SDK Key. (https://app.configcat.com/sdkkey)
     */
    public async updateSettingValueBySdkkey (settingKeyOrId: string, jsonPatch: JsonPatch, reason?: string, xCONFIGCATSDKKEY?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SettingValueModel;  }> {
        const localVarPath = this.basePath + '/v1/settings/{settingKeyOrId}/value'
            .replace('{' + 'settingKeyOrId' + '}', encodeURIComponent(String(settingKeyOrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
